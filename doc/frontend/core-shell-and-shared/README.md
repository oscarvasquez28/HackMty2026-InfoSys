...
5. **Brand Identity & Visual Metaphor** (`frontend/components/PolarMark.tsx`): The SVG iceberg brand icon representing Polar's core mission: revealing the 90% of connected financial crime hidden beneath the surface.
...
| `frontend/components/PolarMark.tsx` | Polar SVG brand logo with styled iceberg geometry (cap above water line, submerged crystalline base). | `PolarMark`, `PolarMarkProps` |
