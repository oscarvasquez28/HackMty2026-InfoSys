...
| [`components/ThoughtStream.tsx`](file:///c:/Users/maxan/OneDrive/Documentos/Repositories/HackMTY%202026/Infosys/Polar/frontend/components/ThoughtStream.tsx) | Collapsible dark terminal console rendering real-time forensic reasoning steps. | `ThoughtStream`, `ThoughtStreamProps` |
| [`components/VerdictCard.tsx`](file:///c:/Users/maxan/OneDrive/Documentos/Repositories/HackMTY%202026/Infosys/Polar/frontend/components/VerdictCard.tsx) | Executive verdict presentation with risk badges, financial breakdown, UIF/GAFI legal text, and suspect entities list. | `VerdictCard`, `VerdictCardProps` |
